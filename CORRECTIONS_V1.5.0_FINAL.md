...
```env
FRONTEND_URL=https://surveillance-plus.preview.emergentagent.com
BACKEND_URL=https://surveillance-plus.preview.emergentagent.com
```
...
curl -X GET https://votre-backend.com/api/users \
  -H "Origin: https://surveillance-plus.preview.emergentagent.com"
```
...
4. ✅ `/app/backend/.env` :
   - Ajout `FRONTEND_URL=https://surveillance-plus.preview.emergentagent.com`
   - Ajout `BACKEND_URL=https://surveillance-plus.preview.emergentagent.com`
...
# Ouvrir : https://surveillance-plus.preview.emergentagent.com/login
...
curl -X GET https://surveillance-plus.preview.emergentagent.com/api/version \
  -H "Origin: https://surveillance-plus.preview.emergentagent.com"
