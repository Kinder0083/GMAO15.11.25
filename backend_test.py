...
class SurveillanceTester:
    ...
    def run_surveillance_tests(self):
        ...
        self.log("- Badge de notification (NOUVEAU)")
        ...
        self.log("8. NOUVEAU: Tester le badge de notification (GET /api/surveillance/badge-stats)")
        self.log("9. SÉCURITÉ: Tester badge sans authentification (doit échouer)")
        self.log("10. Upload d'une pièce jointe")
        self.log("11. Export du template CSV")
        self.log("12. Supprimer un item (admin uniquement)")
        self.log("13. Nettoyer les items de test créés")
        self.log("=" * 80)
